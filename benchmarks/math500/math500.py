...
class Math500:
   def __init__(self, llmA: Model = None, llmB: Model = None, llm_as_judge: Model = None, smoketest_reproducibility=False):
      ...
      self.math500 = load_dataset("HuggingFaceh4/MATH-500", split="test", streaming=True)
...

{
   ...
   def generate_and_evaluate_llmb_base(self):
      ...
      with open("data/math500.jsonl", "a", encoding="utf-8") as f:
         for i, example in enumerate(self.math500):
            try:
   ...
   def generate_and_evaluate_llma_base(self):
      ...
      with open("data/math500.jsonl", "r") as master, open("data/math500.tmp", "w") as temp:
         for line in master:
      ...
      os.replace("data/math500.tmp", "data/math500.jsonl")
